...
new WorkloadSuite("variant") {
  ...
  test("var_002_basic_stats", "Basic variant stats", "variant") { w =>
  ...
  test("var_003_nested_stats", "Nested variant stats", "variant") { w =>
    w.sql("""CREATE TABLE tbl (v VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
  ...
  test("var_004_non_objects", "Non-objects in variant", "variant") { w =>
  ...
  test("var_005_null_counts", "Null counts in variant", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, v VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
      (1, PARSE_JSON('{"a":1}')),
  ...
  test("var_006_different_types", "Variant stats with different data types", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, v VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
  ...
  test("var_009_unusual_chars", "Unusual characters in field names", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, v VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
  ...
  test("var_010_nested_fields", "Deeply nested fields in variant", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, v VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
  ...
  test("var_011_missing_values", "Missing values in variant", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, v VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
  ...
  test("var_012_mixed_types", "Mixed types for same field", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, v VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
      (1, PARSE_JSON('{"x":1}')),
  ...
  test("var_013_extreme_values", "Extreme values in variant", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, v VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
  ...
  test("var_015_string_skipping", "Data skipping with string values", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, v VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("var_017_map_variant", "Read MAP<STRING, VARIANT> column", "variant") { w =>
  ...
  test("var_cdf_read", "Variant with CDF enabled", "variant", "cdf") { w =>
    w.sql("""CREATE TABLE tbl (id INT, data VARIANT) USING delta
  ...
  test("var_deeply_nested", "Variant with deeply nested JSON", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, data VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
  ...
  test("var_large_array", "Variant with large JSON array", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, data VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("var_null_top_level", "Variant with SQL NULL top-level value", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, data VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
      (1, PARSE_JSON('{"a":1}')),
  ...
  test("var_numeric_precision", "Variant with numeric precision edge cases", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, data VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
  ...
  test("var_predicate_non_variant", "Predicate on non-variant column with variant present", "variant") { w =>
  ...
  test("var_projection", "Column projection on variant table", "variant") { w =>
  ...
  test("var_unicode_escapes", "Variant with unicode and escape sequences", "variant") { w =>
    w.sql("""CREATE TABLE tbl (id INT, data VARIANT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("""INSERT INTO tbl VALUES
