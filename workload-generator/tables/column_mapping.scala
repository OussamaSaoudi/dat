new WorkloadSuite("column_mapping") {
  ...
  test("cm_rename_column", "Read after column rename with column mapping", "column_mapping") { w =>
  ...
  test("cm_drop_column", "Read after column drop with column mapping", "column_mapping") { w =>
  ...
  test("cm_drop_readd", "Drop and re-add column with same name (CM)", "column_mapping") { w =>
  ...
  test("cm_nested_columns", "Nested columns with column mapping", "column_mapping") { w =>
  ...
  test("cm_mode_upgrade", "Column mapping mode upgrade from none to name", "column_mapping") { w =>
  ...
  test("cm_upgrade", "Read after column mapping upgrade", "column_mapping") { w =>
  ...
  test("cm_mode_upgrade_partitioned", "Upgrade none to name on partitioned table", "column_mapping") { w =>
  ...
  test("cm_special_chars", "Column names with spaces, dots, backticks", "column_mapping") { w =>
  ...
  test("cm_array_of_structs", "Column mapping with array of structs", "column_mapping") { w =>
  ...
  test("cm_complex_types", "Complex types (array, map) with column mapping", "column_mapping") { w =>
  ...
  test("cm_map_type", "Column mapping with map type columns", "column_mapping") { w =>
  ...
  test("cm_deeply_nested", "3+ level nested schema with CM", "column_mapping") { w =>
  ...
  test("cm_drop_readd_same_name", "Drop and re-add column with same name but different type", "column_mapping") { w =>
    w.sql("""CREATE TABLE tbl (id INT, x STRING) USING delta
      TBLPROPERTIES ('delta.columnMapping.mode' = 'name',
        'delta.minReaderVersion' = '2', 'delta.minWriterVersion' = '5')""")
  ...
  test("cm_predicate_after_rename", "Predicate on column after rename (name mode)", "column_mapping") { w =>
  ...
  test("cm_predicate_on_readded", "Predicate on dropped+re-added column", "column_mapping") { w =>
  ...
  test("cm_predicate_renamed_partition", "Filter on renamed partition column", "column_mapping") { w =>
  ...
  test("cm_rename_partition_col", "Rename partition column", "column_mapping") { w =>
  ...
  test("cm_nested_struct_name", "Column mapping with nested struct (name mode) + projection", "column_mapping") { w =>
  ...
  test("cm_nested_struct_id", "Column mapping with nested struct (id mode)", "column_mapping") { w =>
  ...
  test("cm_nested_rename_3_levels", "Rename deeply nested struct field", "column_mapping") { w =>
    w.sql("""CREATE TABLE tbl (
      id INT,
  ...
  test("cm_filter_pushdown_physical_names", "Filters pushed down to parquet use physical names", "column_mapping") { w =>
  ...
  test("cm_physical_name_matches_logical", "Physical name coincidentally equals new logical name", "column_mapping") { w =>
  ...
  test("cm_id_mode_rename_projection", "ID mode rename + column projection", "column_mapping") { w =>
  ...
  test("cm_id_mode_schema_evolution", "Add column in id mode", "column_mapping") { w =>
  ...
  test("cm_id_matching_swapped", "ID mode: swapped field ID reads other column data", "column_mapping") { w =>
  ...
  test("cm_id_matching_nonexistent", "ID mode: non-existing field ID returns null", "column_mapping") { w =>
    w.sql("""CREATE TABLE tbl (id INT, name STRING) USING delta
      TBLPROPERTIES ('delta.columnMapping.mode' = 'id',
        'delta.minReaderVersion' = '2', 'delta.minWriterVersion' = '5')""")
  ...
  test("cm_projection_complex_types", "Project array/map types with column mapping", "column_mapping") { w =>
    w.sql("""CREATE TABLE tbl (
      id INT,
      arr ARRAY<INT>,
      mp MAP<STRING, INT>,
  ...
  test("cm_select_after_drop", "Explicit projection after column drop (CM name mode)", "column_mapping") { w =>
  ...
  test("cm_err_003_invalid_mode", "Column mapping with unsupported mode in metadata", "column_mapping") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
