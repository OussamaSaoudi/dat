new WorkloadSuite("corruption") {
  ...
  test("corrupt_missing_file", "Deleted parquet file", "corrupt") { w =>
  ...
  test("corrupt_truncated_commit", "Half-written commit", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
  ...
  test("corrupt_no_crc", "No CRC files", "corrupt") { w =>
  ...
  test("corrupt_empty_crc", "Empty CRC file", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id LONG) USING delta")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
    w.mutateTable(t) { dir =>
  ...
  test("corrupt_bad_stats", "Bogus file stats", "corrupt") { w =>
  ...
  test("corrupt_version_gap", "Missing version in log", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
  ...
  test("corrupt_no_protocol", "Protocol stripped from commit 0", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
    w.sql("INSERT INTO tbl VALUES (1)")
    val t = w.table("tbl")
    w.mutateTable(t) { dir =>
  ...
  test("corrupt_no_metadata", "Metadata stripped from commit 0", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
    w.sql("INSERT INTO tbl VALUES (1)")
    val t = w.table("tbl")
    w.mutateTable(t) { dir =>
  ...
  test("corrupt_stale_last_checkpoint", "Stale _last_checkpoint hint", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
  ...
  test("corrupt_invalid_last_checkpoint", "Invalid JSON in _last_checkpoint", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val loc = w.spark.sql("DESCRIBE DETAIL tbl").collect()(0).getAs[String]("location")
    org.apache.spark.sql.delta.DeltaLog.forTable(w.spark, loc).checkpoint()
  ...
  test("corrupt_empty_delta_log", "Empty _delta_log", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
    w.sql("INSERT INTO tbl VALUES (1)")
    val t = w.table("tbl")
    w.mutateTable(t) { dir =>
  ...
  test("corrupt_zero_byte_commit", "Zero-byte commit file", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
    w.sql("INSERT INTO tbl VALUES (1)")
    val t = w.table("tbl")
    w.mutateTable(t) { dir =>
  ...
  test("corrupt_dv_garbled", "Garbled DV binary", "corrupt", "dv") { w =>
    w.sql("""CREATE TABLE tbl (id INT) USING delta
  ...
  test("corrupt_unknown_action", "Unknown action type in commit", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id LONG) USING delta")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
    w.mutateTable(t) { dir =>
  ...
  test("ct_duplicate_metadata", "Commit with two Metadata actions", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("ct_duplicate_protocol", "Commit with two Protocol actions", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("ct_empty_delta_log", "Empty _delta_log directory", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
    w.sql("INSERT INTO tbl VALUES (1)")
    val t = w.table("tbl")
    w.mutateTable(t) { dir =>
  ...
  test("ct_gap_in_versions", "Version gap (0, 1, 3 - version 2 missing)", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
  ...
  test("ct_invalid_json", "Commit JSON with invalid syntax", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("ct_missing_data_file", "Parquet file referenced in log but deleted", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("ct_missing_delta_log", "Directory without _delta_log", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
    w.sql("INSERT INTO tbl VALUES (1)")
    val t = w.table("tbl")
    w.mutateTable(t) { dir =>
  ...
  test("ct_missing_metadata", "Commit 0 missing Metadata action", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("ct_missing_protocol", "Commit 0 missing Protocol action", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("ct_only_remove_file", "Commit with only RemoveFile action", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("ct_unknown_action_types", "Commit with unknown action type", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("ct_zero_byte_commit", "Zero-byte commit 0 file", "corrupt") { w =>
    w.sql("CREATE TABLE tbl (id INT) USING delta")
    w.sql("INSERT INTO tbl VALUES (1)")
    val t = w.table("tbl")
    w.mutateTable(t) { dir =>
  ...
  test("corrupt_crc_negative_counts", "CRC with negative fileCounts", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("corrupt_crc_no_metadata", "CRC missing metadata/protocol", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("corrupt_crc_txnid_mismatch", "CRC txnId doesn't match commit", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("corrupt_crc_wrong_numfiles", "CRC numFiles doesn't match actual", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("corrupt_incomplete_multipart_checkpoint", "Multi-part checkpoint with missing part file", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
  ...
  test("corrupt_last_checkpoint_checksum_mismatch", "Content doesn't match its checksum", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val loc = w.spark.sql("DESCRIBE DETAIL tbl").collect()(0).getAs[String]("location")
  ...
  test("corrupt_malformed_last_checkpoint", "Invalid JSON in _last_checkpoint", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val loc = w.spark.sql("DESCRIBE DETAIL tbl").collect()(0).getAs[String]("location")
  ...
  test("corrupt_malformed_stats_json", "AddFile with corrupted stats JSON", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("corrupt_missing_last_checkpoint", "_last_checkpoint absent", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("corrupt_stale_checkpoint_extra_files", "Checkpoint has more files than log", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    w.sql("INSERT INTO tbl SELECT id FROM range(10, 20)")
  ...
  test("corrupt_truncated_commit_json", "Commit JSON truncated mid-line", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("corrupt_wrong_last_checkpoint", "_last_checkpoint points to non-existent version", "corrupt", "resilience") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("err_dv_invalid_storage_type", "DV with unknown storageType", "corrupt", "dv") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
    w.sql("DELETE FROM tbl WHERE id = 2")
  ...
  test("err_duplicate_add_same_version", "Same path added twice in one commit", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("err_missing_version_0", "Missing version 0 JSON", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    w.sql("INSERT INTO tbl SELECT id FROM range(10, 20)")
  ...
  test("err_schema_empty", "metaData has empty schemaString", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
  ...
  test("err_schema_invalid_json", "metaData schemaString is invalid JSON", "corrupt") { w =>
    w.sql("""CREATE TABLE tbl (id BIGINT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    val t = w.table("tbl")
