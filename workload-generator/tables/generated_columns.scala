...
workload("gc_basic", "Basic generated column (id * 2)", "generatedColumns") { w =>
...
workload("gc_arithmetic_expr", "Generated column with arithmetic expression", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    price DOUBLE,
    quantity INT,
...
workload("gc_case_when", "Generated column with CASE WHEN", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    value INT,
...
workload("gc_coalesce_null", "Generated column with COALESCE", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    nickname STRING,
    first_name STRING,
...
workload("gc_concat_expr", "Generated column with CONCAT", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    first_name STRING,
    last_name STRING,
...
workload("gc_date_format_expr", "Generated column with DATE_FORMAT", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    event_date DATE,
...
workload("gc_datetime", "Generated columns from timestamp", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
...
workload("gc_math", "Generated column with SQRT expression", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    x DOUBLE,
    y DOUBLE,
...
workload("gc_multiple", "Multiple generated columns", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    id LONG,
    doubled LONG GENERATED ALWAYS AS (id * 2),
...
workload("gc_nested", "Generated column from struct field", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
...
workload("gc_null_expression_result", "Generated column that can be NULL", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    value STRING,
...
workload("gc_partition_col", "Generated column as partition column", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    date_col DATE,
    value INT,
...
workload("gc_partitioned", "Partitioned table with generated column", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    id LONG,
    value STRING,
...
workload("gc_reference", "Generated column referencing other columns", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    first_name STRING,
    last_name STRING,
    full_name STRING GENERATED ALWAYS AS (CONCAT(first_name, ' ', last_name))
...
workload("gc_string", "Generated column with string function", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    email STRING,
...
workload("gc_ctas", "Generated column with CTAS pattern", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    id LONG,
    doubled LONG GENERATED ALWAYS AS (id * 2)
  ) USING delta TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
...
workload("gc_time_travel", "Generated columns with time travel", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    id LONG,
    doubled LONG GENERATED ALWAYS AS (id * 2)
  ) USING delta TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
...
workload("gc_added_via_alter_table", "Column added via ALTER TABLE alongside generated column", "generatedColumns") { w =>
  w.sql("""CREATE TABLE tbl (
    id INT,
