...
new WorkloadSuite("write_insert") {
  ...
  // COMMENTED OUT: INSERT OVERWRITE is not supported as structured op
  // ==========================================================================
  // test("dii001_insert_overwrite_partition_constants",
  //     "Partitioned table with INSERT OVERWRITE using static partition clauses",
  //     "write", "insert", "overwrite", "partitioned") {
  //   val t = createTableOp("tbl",
  //     schema = "a INT, b INT, c INT",
  //     partitionColumns = Seq("b", "c"))
  //   sql("INSERT OVERWRITE TABLE tbl PARTITION (c=3) SELECT 1, 2")
  //   sql("INSERT OVERWRITE TABLE tbl PARTITION (b=2, c=3) SELECT 1")
  //   sql("INSERT OVERWRITE TABLE tbl PARTITION (b=2, c) SELECT 1, 3")
  //   registerWriteSpec(writeSpec(t))
  //   read(t, name = "read_final")
  //   read(t, version = 1, name = "after_first_overwrite")
  //   read(t, version = 2, name = "after_second_overwrite")
  //   read(t, version = 3, name = "after_third_overwrite")
  //   snapshot(t)
  // }
  ...
  test("dii002_append_by_name",
    ...
    val w = createTableOp("tbl",
      schema = "id BIGINT, data STRING")
    insertOp(w, Seq(Map("id" -> 1, "data" -> "a")))
    insertOp(w, Seq(Map("data" -> "b", "id" -> 2)))
    insertOp(w, Seq(Map("data" -> "c", "id" -> 3)))
  ...
  //   val t = createTableOp("tbl",
  //     schema = "id BIGINT, data STRING")
  //   sql("INSERT OVERWRITE tbl(id, data) VALUES(1, 'a')")
  //   sql("INSERT OVERWRITE tbl(data, id) VALUES('b', 2)")
  //   sql("INSERT OVERWRITE tbl(data, id) VALUES('c', 3)")
  //   registerWriteSpec(writeSpec(t))
  //   read(t, name = "read_all")
  //   read(t, version = 1, name = "after_first_overwrite")
  //   read(t, version = 2, name = "after_second_overwrite")
  ...
  test("dii005_append_partitioned",
    ...
    val t = registerWriteSpec(w)
    read(t, name = "read_all")
    read(t, predicate = "id = 2", name = "read_partition_2")
    snapshot(t)
  }
  ...
  //     Map("id" -> 2, "data" -> "b"),
  //     Map("id" -> 3, "data" -> "c")))
  //   sql("INSERT OVERWRITE tbl VALUES (4, 'd'), (5, 'e'), (6, 'f')")
  //   registerWriteSpec(writeSpec(t))
  ...
  //   sql("INSERT OVERWRITE tbl VALUES (1, 'a'), (2, 'b'), (3, 'c')")
  //   registerWriteSpec(writeSpec(t))
  //   read(t, name = "read_after_overwrite")
  //   read(t, version = 1, name = "read_before_overwrite")
  //   snapshot(t)
  ...
  test("dii008_append_partitioned_static_clause",
    ...
    val t = registerWriteSpec(w)
    read(t, name = "read_all")
    read(t, predicate = "id = 23", name = "read_partition_23")
    snapshot(t)
  }
  ...
  //   sql("CREATE OR REPLACE TEMP VIEW src_dii009 AS SELECT * FROM VALUES (1, 'a'), (2, 'b'), (3, 'c') AS t(id, data)")
  //   sql("SET spark.sql.sources.partitionOverwriteMode = static")
  //   sql("INSERT OVERWRITE TABLE tbl PARTITION (id) SELECT * FROM src_dii009")
  //   registerWriteSpec(writeSpec(t))
  //   read(t, name = "read_after_overwrite")
  //   read(t, version = 1, name = "read_before_overwrite")
  //   snapshot(t)
  ...
  //     Map("id" -> 2, "data" -> "dummy"),
  //     Map("id" -> 4, "data" -> "keep")))
  //   sql("CREATE OR REPLACE TEMP VIEW src_dii010 AS SELECT * FROM VALUES (1, 'a'), (2, 'b'), (3, 'c') AS t(id, data)")
  //   sql("SET spark.sql.sources.partitionOverwriteMode = dynamic")
  //   sql("INSERT OVERWRITE TABLE tbl PARTITION (id) SELECT * FROM src_dii010")
  //   registerWriteSpec(writeSpec(t))
  //   read(t, name = "read_after_overwrite")
  //   read(t, version = 1, name = "read_before_overwrite")
  //   read(t, predicate = "id = 4", name = "read_preserved_partition")
  //   snapshot(t)
  // }
  ...
  test("dii011_schema_evolution_merge_schema",
      ...
      "write", "insert", "schema_evolution") {
    val w = createTableOp("tbl",
      schema = "id BIGINT, data STRING")
    sql("SET spark.delta.schema.autoMerge.enabled = true")
    sql("INSERT INTO tbl VALUES (1, 'a', 'mango')")
    val t = registerWriteSpec(w)
    read(t, name = "read_all")
    snapshot(t)
  }
  ...
  //     Map("id" -> 2, "data" -> "dummy"),
  //     Map("id" -> 4, "data" -> "also-deleted")))
  //   sql("CREATE OR REPLACE TEMP VIEW src_dii012 AS SELECT * FROM VALUES (1, 'a'), (2, 'b'), (3, 'c') AS t(id, data)")
  //   sql("SET spark.sql.sources.partitionOverwriteMode = static")
  //   sql("INSERT OVERWRITE TABLE tbl SELECT * FROM src_dii012")
  //   registerWriteSpec(writeSpec(t))
  //   read(t, name = "read_after_overwrite")
  //   read(t, version = 1, name = "read_before_overwrite")
  //   snapshot(t)
  ...
  test("dii013_insert_nested_struct",
      ...
      "write", "insert", "nested") {
    val w = createTableOp("tbl",
      schema = "num INT, text STRING, s STRUCT<a: STRING, s2: STRUCT<c: STRING, d: STRING>, b: STRING>")
    sql("INSERT INTO tbl VALUES (1, 'a', struct('a', struct('c', 'd'), 'b'))")
    val t = registerWriteSpec(w)
    read(t, name = "read_all")
    snapshot(t)
  }
  ...
  test("dii014_ctas_basic",
      ...
      "write", "insert", "ctas") {
    sql("CREATE TABLE tbl USING delta AS SELECT id, CAST(id AS STRING) AS data FROM RANGE(100)")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
    read(t, predicate = "id < 10", name = "read_first_10")
    snapshot(t)
  }
  ...
  test("dii015_ctas_partitioned",
      ...
      "write", "insert", "ctas", "partitioned") {
    sql("CREATE TABLE tbl USING delta PARTITIONED BY (part) AS SELECT id, CAST(id % 5 AS INT) AS part FROM RANGE(100)")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
    read(t, predicate = "part = 0", name = "read_partition_0")
    read(t, predicate = "part = 3", name = "read_partition_3")
    snapshot(t)
  }
  ...
  test("dii016_various_data_types",
      ...
      "write", "insert", "types") {
    val w = createTableOp("tbl",
      schema = "i INT, l BIGINT, f FLOAT, d DOUBLE, s STRING, b BOOLEAN, dt DATE")
    ...
    val t = registerWriteSpec(w)
    read(t, name = "read_all")
    read(t, predicate = "i IS NOT NULL", name = "read_non_null")
    read(t, predicate = "b = true", name = "read_boolean_true")
    snapshot(t)
  }
  ...
  //     Map("id" -> 2, "data" -> "b"),
  //     Map("id" -> 3, "data" -> "c")))
  //   sql("INSERT OVERWRITE tbl VALUES (4, 'd'), (5, 'e')")
  //   registerWriteSpec(writeSpec(t))
  //   read(t, name = "read_after_overwrite")
  //   read(t, version = 1, name = "read_before_overwrite")
  ...
  test("ct002_ctas_sql",
      ...
      "write", "ctas") {
    sql("CREATE OR REPLACE TEMP VIEW src_ct002 AS SELECT * FROM VALUES (1, 'a'), (2, 'b'), (3, 'c') AS t(key, value)")
    sql("CREATE TABLE tbl USING delta AS SELECT * FROM src_ct002")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
    snapshot(t)
  ...
  test("ct003_ctas_partitioned",
      ...
      "write", "ctas", "partitioned") {
    sql("CREATE OR REPLACE TEMP VIEW src_ct003 AS SELECT * FROM VALUES (1, 'a', 'p1'), (2, 'b', 'p2'), (3, 'c', 'p1') AS t(key, value, part)")
    sql("CREATE TABLE tbl USING delta PARTITIONED BY (part) AS SELECT * FROM src_ct003")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
  ...
  test("ct005_insert_select_from_table",
    ...
    sql("CREATE TABLE tbl USING delta AS SELECT * FROM VALUES (1, 'a'), (2, 'b') AS t(key, value)")
    // Create source as a temp view
    sql("CREATE OR REPLACE TEMP VIEW src_ct005 AS SELECT * FROM VALUES (3, 'c'), (4, 'd') AS t(key, value)")
    sql("INSERT INTO tbl SELECT * FROM src_ct005")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
    read(t, version = 0, name = "read_initial")
    snapshot(t)
  }
  ...
  test("ct006_insert_select_transform",
      ...
      "write", "insert") {
    sql("CREATE TABLE tbl USING delta AS SELECT * FROM VALUES (1, 10) AS t(key, value)")
    sql("CREATE OR REPLACE TEMP VIEW src_ct006 AS SELECT * FROM VALUES (2, 20), (3, 30) AS t(key, value)")
    sql("INSERT INTO tbl SELECT key, value * 2 as value FROM src_ct006")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
    read(t, version = 0, name = "read_initial")
  ...
  test("ct007_insert_select_with_filter",
      ...
      "write", "insert") {
    sql("CREATE TABLE tbl USING delta AS SELECT * FROM VALUES (1, 100) AS t(key, value)")
    sql("CREATE OR REPLACE TEMP VIEW src_ct007 AS SELECT * FROM VALUES (2, 5), (3, 15), (4, 25), (5, 3) AS t(key, value)")
    sql("INSERT INTO tbl SELECT * FROM src_ct007 WHERE value > 10")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
    read(t, version = 0, name = "read_initial")
  ...
  test("ct008_insert_select_join",
    ...
    sql("CREATE OR REPLACE TEMP VIEW table_a AS SELECT * FROM VALUES (1, 100), (2, 200), (3, 300) AS t(key, amount)")
    sql("CREATE OR REPLACE TEMP VIEW table_b AS SELECT * FROM VALUES (1, 'alice'), (2, 'bob'), (4, 'dave') AS t(key, name)")
  ...
  test("ct009_insert_select_aggregate",
    ...
    sql("CREATE OR REPLACE TEMP VIEW src_ct009 AS SELECT * FROM VALUES ('electronics', 100), ('electronics', 200), ('books', 50), ('books', 30) AS t(category, amount)")
    sql("INSERT INTO tbl SELECT category, SUM(amount) as total FROM src_ct009 GROUP BY category")
    val t = registerWriteSpec(w)
    read(t, name = "read_all")
    read(t, predicate = "category = 'electronics'", name = "read_electronics")
    snapshot(t)
  }
  ...
  //     "write", "insert", "overwrite") {
  //   sql("CREATE TABLE tbl USING delta AS SELECT * FROM VALUES (1, 'old_a'), (2, 'old_b') AS t(key, value)")
  //   sql("INSERT OVERWRITE tbl SELECT * FROM VALUES (10, 'new_x'), (20, 'new_y'), (30, 'new_z') AS t(key, value)")
  //   val t = registerTable("tbl")
  //   registerWriteSpec(writeSpec(t))
  //   read(t, name = "read_after_overwrite")
  //   read(t, version = 0, name = "read_original")
  //   snapshot(t)
  // }
  ...
  test("ct011_ctas_mixed_types",
    ...
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
    read(t, predicate = "active = true", name = "read_active")
    snapshot(t)
  }
  ...
  test("ct013_insert_select_union_all",
      ...
      "write", "insert") {
    sql("CREATE TABLE tbl USING delta AS SELECT * FROM VALUES (1, 'initial') AS t(key, value)")
    sql("CREATE OR REPLACE TEMP VIEW src1_ct013 AS SELECT * FROM VALUES (2, 'from_source1'), (3, 'from_source1') AS t(key, value)")
    sql("CREATE OR REPLACE TEMP VIEW src2_ct013 AS SELECT * FROM VALUES (4, 'from_source2'), (5, 'from_source2') AS t(key, value)")
    sql("INSERT INTO tbl SELECT * FROM src1_ct013 UNION ALL SELECT * FROM src2_ct013")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
    read(t, version = 0, name = "read_initial")
  ...
  test("ct014_ctas_empty",
      ...
      "write", "ctas") {
    sql("CREATE OR REPLACE TEMP VIEW src_ct014 AS SELECT CAST(NULL AS INT) AS key, CAST(NULL AS STRING) AS value WHERE false")
    sql("CREATE TABLE tbl USING delta AS SELECT * FROM src_ct014")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
  ...
  test("ct015_insert_select_column_reorder",
      ...
      "write", "insert") {
    sql("CREATE TABLE tbl USING delta AS SELECT * FROM VALUES (1, 'a') AS t(key, value)")
    sql("CREATE OR REPLACE TEMP VIEW src_ct015 AS SELECT * FROM VALUES ('b', 2), ('c', 3) AS t(value, key)")
    sql("INSERT INTO tbl (value, key) SELECT value, key FROM src_ct015")
    val t = registerTable("tbl")
    registerWriteSpec(writeSpec(t))
    read(t, name = "read_all")
    read(t, version = 0, name = "read_initial")
