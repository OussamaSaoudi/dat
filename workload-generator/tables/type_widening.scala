...
new WorkloadSuite("type_widening") {
  ...
  test("tw_short_to_int", "Short to int widening", "type_widening") { w =>
  ...
  test("tw_short_to_long", "Short to long widening (via int)", "type_widening") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value SHORT) USING delta
      TBLPROPERTIES ('delta.enableTypeWidening' = 'true', 'delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1, CAST(100 AS SHORT)), (2, CAST(32767 AS SHORT))")
    w.sql("ALTER TABLE tbl ALTER COLUMN value TYPE INT")
  ...
  test("tw_int_to_long", "Read after int to long widening", "type_widening") { w =>
  ...
  test("tw_full_numeric_chain", "Full widening chain: byte -> short -> int -> long", "type_widening") { w =>
    w.sql("""CREATE TABLE tbl (a BYTE) USING delta
      TBLPROPERTIES ('delta.enableTypeWidening' = 'true', 'delta.enableDeletionVectors' = 'true')""")
  ...
  test("tw_float_to_double", "Float to double widening", "type_widening") { w =>
  ...
  test("tw_decimal_precision", "Decimal precision widening (5,2) -> (10,2)", "type_widening") { w =>
  ...
  test("tw_cross_physical_decimal", "Cross-physical-type decimal widening (INT32->INT64->FIXED)", "type_widening") { w =>
  ...
  test("tw_date_to_timestamp_ntz", "Date to TimestampNTZ widening", "type_widening") { w =>
  ...
  test("tw_array_element", "Array element type widening (array<int> -> array<long>)", "type_widening") { w =>
  ...
  test("tw_map_key_value_widening", "Map key/value type widening (map<byte,short> -> map<int,int>)", "type_widening") { w =>
  ...
  test("tw_with_partition", "Type widening in partitioned table", "type_widening", "partition") { w =>
  ...
  test("tw_with_column_mapping", "Column mapping + type widening combined", "type_widening", "column_mapping") { w =>
  ...
  test("tw_colmap_rename", "Type change + column rename combined", "type_widening", "column_mapping") { w =>
  ...
  test("tw_cdf_across_widening", "CDF spanning type widening change", "type_widening", "cdf") { w =>
  ...
  test("tw_row_tracking_combo", "Type widening + row tracking combined", "type_widening") { w =>
  ...
  test("tw_stats_after_change", "Data skipping after type change", "type_widening") { w =>
  ...
  test("tw_project_widened", "Project only the widened column", "type_widening") { w =>
  ...
  test("tw_project_non_widened", "Project excluding widened column", "type_widening") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value INT, label STRING) USING delta
      TBLPROPERTIES ('delta.enableTypeWidening' = 'true', 'delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1, 100, 'a'), (2, 200, 'b')")
    w.sql("ALTER TABLE tbl ALTER COLUMN value TYPE LONG")
