...
new WorkloadSuite("merge") {
  ...
  test("mergeBasicUpdate", "MERGE with only UPDATE clause", "merge", "dml") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeBasicDelete", "MERGE with only DELETE clause", "merge", "dml") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
    w.sql("""MERGE INTO tbl t USING (SELECT * FROM VALUES (2,'x') AS s(id, value)) s
  ...
  test("mergeInsertUpdate", "MERGE with INSERT and UPDATE clauses", "merge", "dml") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
  ...
  test("mergeInsertDelete", "MERGE with INSERT and DELETE clauses", "merge", "dml") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
  ...
  test("mergeInsertUpdateDelete", "MERGE with INSERT, UPDATE, and DELETE", "merge", "dml") { w =>
  ...
  test("mergeUpdateDelete", "MERGE with conditional UPDATE and DELETE", "merge", "dml") { w =>
    w.sql("""CREATE TABLE tbl (id INT, val INT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,10),(2,20),(3,30)")
  ...
  test("mergeMultipleMatched", "MERGE with multiple WHEN MATCHED clauses", "merge", "dml") { w =>
  ...
  test("mergeConditionalUpdate", "MERGE with conditional WHEN MATCHED", "merge", "dml") { w =>
  ...
  test("mergeStarUpdate", "MERGE with UPDATE SET * syntax", "merge", "dml") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("""MERGE INTO tbl t USING (SELECT * FROM VALUES (2,'x') AS s(id, value)) s
  ...
  test("mergeSourceAggregation", "MERGE with aggregated source", "merge", "dml") { w =>
  ...
  test("mergeDecimalValues", "MERGE with decimal value columns", "merge", "dml") { w =>
  ...
  test("mergeTimestampValues", "MERGE with timestamp columns", "merge", "dml") { w =>
  ...
  test("mergeStringKeys", "MERGE on string key columns", "merge", "dml") { w =>
  ...
  test("mergeWithMapCol", "MERGE with map columns", "merge", "dml") { w =>
  ...
  test("mergeWithNestedStruct", "MERGE with nested struct columns", "merge", "dml") { w =>
  ...
  test("mergePartitionedCrossPartition", "MERGE cross-partition row movement", "merge", "dml", "partitioned") { w =>
    w.sql("""CREATE TABLE tbl (id INT, region STRING, amount INT) USING delta
      PARTITIONED BY (region)
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergePartitionedMultiCol", "MERGE with multiple partition columns", "merge", "dml", "partitioned") { w =>
  ...
  test("mergeDvConditionalUpdate", "Conditional UPDATE with DVs", "merge", "dml", "dv") { w =>
  ...
  test("mergeDvDeleteClause", "Merge with DELETE clause on DV-enabled table", "merge", "dml", "dv") { w =>
  ...
  test("mergeDvLargeTable", "Merge on larger DV table (100+ rows)", "merge", "dml", "dv") { w =>
  ...
  test("mergeDvMultipleMatched", "Multiple WHEN MATCHED clauses with DVs", "merge", "dml", "dv") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING, amount INT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeDvMultipleMerges", "Multiple consecutive merges on DV table", "merge", "dml", "dv") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
    w.sql("DELETE FROM tbl WHERE id = 2")
  ...
  test("mergeDvNullHandling", "Merge with null values on DV table", "merge", "dml", "dv") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeDvPartitioned", "Merge on partitioned DV table", "merge", "dml", "dv", "partitioned") { w =>
  ...
  test("mergeDvSchemaEvolution", "Schema evolution merge on DV table", "merge", "dml", "dv", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
  ...
  test("mergeDvStarSyntax", "Merge with INSERT * and UPDATE SET * with DVs", "merge", "dml", "dv") { w =>
    w.sql("""CREATE TABLE tbl (id INT, name STRING, score INT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeLowShuffleConditional", "Low shuffle with conditional clauses", "merge", "dml", "low_shuffle") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING, amount INT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeLowShuffleDecimal", "Low shuffle with decimal columns", "merge", "dml", "low_shuffle") { w =>
    w.sql("""CREATE TABLE tbl (id INT, price DECIMAL(10,2)) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeLowShuffleLargeTable", "Low shuffle on larger table (200+ rows)", "merge", "dml", "low_shuffle") { w =>
  ...
  test("mergeLowShuffleMultiClause", "Low shuffle with INSERT+UPDATE+DELETE", "merge", "dml", "low_shuffle") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING, amount INT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeLowShuffleMultiMerge", "Multiple low shuffle merges in sequence", "merge", "dml", "low_shuffle") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("""MERGE INTO tbl t USING (SELECT * FROM VALUES (2,'x'),(3,'c') AS s(id, value)) s
  ...
  test("mergeLowShuffleNested", "Low shuffle with nested struct columns", "merge", "dml", "low_shuffle") { w =>
    w.sql("""CREATE TABLE tbl (id INT, info STRUCT<name: STRING, age: INT>) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeLowShufflePartitioned", "Low shuffle merge on partitioned table", "merge", "dml", "low_shuffle", "partitioned") { w =>
  ...
  test("mergeLowShuffleStar", "Low shuffle with * syntax", "merge", "dml", "low_shuffle") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("""MERGE INTO tbl t USING (SELECT * FROM VALUES (2,'x'),(3,'c') AS s(id, value)) s
  ...
  test("mergeLowShuffleTimestamp", "Low shuffle with timestamp columns", "merge", "dml", "low_shuffle") { w =>
  ...
  test("mergeEdgeNoMatched", "MERGE where no source row matches target (all inserts)", "merge", "dml", "edge") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
  ...
  test("mergeEdgeEmptySource", "MERGE with empty source (no changes)", "merge", "dml", "edge") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
  ...
  test("mergeEdgeEmptyTarget", "MERGE into empty target table", "merge", "dml", "edge") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeEdgeNullJoinKey", "MERGE with null values in join key", "merge", "dml", "edge") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeEdgeSelfMerge", "MERGE table into itself (self-join)", "merge", "dml", "edge") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING, amount INT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a',10),(2,'b',20),(3,'c',30)")
  ...
  test("mergeEdgeSourceAlias", "MERGE with aliased source subquery", "merge", "dml", "edge") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
    w.sql("""MERGE INTO tbl t USING (
  ...
  test("mergeEdgeMultiJoin", "MERGE with complex multi-column join condition", "merge", "dml", "edge") { w =>
  ...
  test("mergeEdgeLargePayload", "MERGE with wide rows (many columns)", "merge", "dml", "edge") { w =>
  ...
  test("mergeEdgeDuplicateSourceKeys", "MERGE with duplicate keys in source (write-path error, table unchanged)", "merge", "dml", "edge") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
  ...
  test("mergeErrDuplicateSource", "Table state after failed MERGE with duplicate source rows", "merge", "dml", "error") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    try {
  ...
  test("mergeErrNoMatchCondition", "Table state after failed MERGE without ON condition", "merge", "dml", "error") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
  ...
  test("mergeErrTypeMismatch", "Table state after failed MERGE with type mismatch", "merge", "dml", "error") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    try {
  ...
  test("mergeSchemaEvoAddMultiCols", "Schema evolution adds multiple new columns", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
  ...
  test("mergeSchemaEvoInsertNewCol", "INSERT * with extra column in source", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
  ...
  test("mergeSchemaEvoInsertMultipleNewCols", "INSERT adds 3+ new columns", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
  ...
  test("mergeSchemaEvoInsertWithDefault", "INSERT new col, existing rows get null", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
  ...
  test("mergeSchemaEvoUpdateNewCol", "UPDATE SET with column not in target", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
  ...
  test("mergeSchemaEvoUpdateStarNewCol", "UPDATE SET * with extra column in source", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
  ...
  test("mergeSchemaEvoInsertUpdateNewCol", "INSERT and UPDATE add same new column", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
  ...
  test("mergeSchemaEvoInsertUpdateDiffCols", "INSERT adds col A, UPDATE adds col B", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
  ...
  test("mergeSchemaEvoUpdateMultipleClauses", "Multiple WHEN MATCHED clauses with schema evolution", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING, amount INT) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeSchemaEvoInsertNestedNewField", "INSERT with nested struct extra field", "merge", "dml", "schema_evolution") { w =>
  ...
  test("mergeSchemaEvoUpdateNestedField", "UPDATE nested struct with new field", "merge", "dml", "schema_evolution") { w =>
  ...
  test("mergeSchemaEvoNestedStructAdd", "Add field to deeply nested struct", "merge", "dml", "schema_evolution") { w =>
  ...
  test("mergeSchemaEvoAddMapEntry", "Merge adds map data with schema evolution", "merge", "dml", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, props MAP<STRING, STRING>) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeSchemaEvoArrayStructEvolution", "Array of structs, add struct field", "merge", "dml", "schema_evolution") { w =>
  ...
  test("mergeSchemaEvoMapValueType", "Merge with map column and schema evolution", "merge", "dml", "schema_evolution") { w =>
  ...
  test("mergeSchemaEvoStructRemoveField", "Merge with struct missing field (null filled)", "merge", "dml", "schema_evolution") { w =>
  ...
  test("mergeSchemaEvoStructReorderFields", "Merge with reordered struct fields", "merge", "dml", "schema_evolution") { w =>
  ...
  test("mergeSchemaEvoStructWithArray", "Struct containing array, add new field", "merge", "dml", "schema_evolution") { w =>
  ...
  test("mergeSchemaEvoPartitionedStructEvo", "Struct evolution on partitioned table", "merge", "dml", "schema_evolution", "partitioned") { w =>
  ...
  test("mergeSchemaEvoWithColumnMapping", "Schema evolution with column mapping", "merge", "dml", "schema_evolution", "column_mapping") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true',
  ...
  test("mergeSchemaEvoDvSchemaEvo", "Schema evolution with deletion vectors", "merge", "dml", "schema_evolution", "dv") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
    w.sql("DELETE FROM tbl WHERE id = 3")
  ...
  test("mergeSchemaEvoErrIncompatibleType", "Table state after incompatible type evolution error", "merge", "dml", "schema_evolution", "error") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
  ...
  test("mergeSchemaEvoErrNarrowType", "Table state after narrowing type error", "merge", "dml", "schema_evolution", "error") { w =>
  ...
  test("mergeStructEvoNullableToNonNull", "Merge target has nullable struct field, source has non-null values", "merge", "dml", "struct_evolution") { w =>
  ...
  test("mergeStructEvoNestedNullField", "Nested struct gets new nullable field via merge", "merge", "dml", "struct_evolution") { w =>
  ...
  test("mergeStructEvoMultiStructCols", "Table with multiple struct columns, merge evolves one", "merge", "dml", "struct_evolution") { w =>
  ...
  test("mergeStructEvoNullInKey", "Merge with null values in struct-type key column", "merge", "dml", "struct_evolution") { w =>
  ...
  test("mergeStructEvoArrayOfStructNull", "Array of structs with null fields after merge evolution", "merge", "dml", "struct_evolution") { w =>
  ...
  test("mergeStructEvoMapValueStructNull", "Map with struct values, merge adds nullable field to struct", "merge", "dml", "struct_evolution") { w =>
  ...
  test("mergeStructEvoDeepNested", "Deeply nested struct (3 levels), add field at leaf level", "merge", "dml", "struct_evolution") { w =>
  ...
  test("mergeStructEvoMixedNull", "Merge where some matched rows get null, others get values for new field", "merge", "dml", "struct_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, info STRUCT<a: INT>) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
  ...
  test("mergeStructEvoPartitionedStruct", "Struct evolution on partitioned table with null handling", "merge", "dml", "struct_evolution", "partitioned") { w =>
  ...
  test("mrb_not_matched_by_source_delete", "MERGE with NOT MATCHED BY SOURCE delete", "merge", "dml", "not_matched_by_source") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
    w.sql("""MERGE INTO tbl t USING (SELECT * FROM VALUES (2,'x') AS s(id, value)) s
  ...
  test("mrb_not_matched_by_source_update", "MERGE with NOT MATCHED BY SOURCE update", "merge", "dml", "not_matched_by_source") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
    w.sql("""MERGE INTO tbl t USING (SELECT * FROM VALUES (2,'x') AS s(id, value)) s
  ...
  test("mrb_with_cdf", "MERGE with CDF enabled", "merge", "dml", "not_matched_by_source", "cdf") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
  ...
  test("mrb_with_dv", "MERGE with deletion vectors", "merge", "dml", "not_matched_by_source", "dv") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b'),(3,'c')")
    w.sql("""MERGE INTO tbl t USING (SELECT * FROM VALUES (2,'x') AS s(id, value)) s
  ...
  test("mrb_with_schema_evolution", "MERGE triggering auto schema evolution", "merge", "dml", "not_matched_by_source", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id INT, value STRING) USING delta
      TBLPROPERTIES ('delta.enableDeletionVectors' = 'true')""")
    w.sql("INSERT INTO tbl VALUES (1,'a'),(2,'b')")
    w.sql("SET spark.databricks.delta.schema.autoMerge.enabled = true")
