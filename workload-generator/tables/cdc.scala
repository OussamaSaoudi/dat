new WorkloadSuite("cdc") {
  ...
  test("cdc_by_path", "CDC by path", "cdf") { w =>
  ...
  test("cdc_version_range", "CDF version ranges", "cdf") { w =>
    w.sql("""CREATE TABLE tbl (id LONG) USING delta
  ...
  test("cdc_single_version", "CDF for single version", "cdf") { w =>
    w.sql("""CREATE TABLE tbl (id LONG) USING delta
      TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    w.sql("INSERT INTO tbl SELECT id + 10 FROM range(10)")
  ...
  test("cdc_inserts", "CDF with INSERT operations", "cdf") { w =>
  ...
  test("cdc_updates", "CDF with UPDATE operations", "cdf") { w =>
  ...
  test("cdc_deletes", "CDF with DELETE operations", "cdf") { w =>
    w.sql("""CREATE TABLE tbl (id LONG, name STRING) USING delta
      TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true')""")
  ...
  test("cdc_merge", "CDF with MERGE", "cdf", "merge") { w =>
  ...
  test("cdc_merge_delete", "MERGE with matched delete clause", "cdf", "merge") { w =>
  ...
  test("cdc_multiple_refs", "Multiple CDF reads", "cdf") { w =>
    w.sql("""CREATE TABLE tbl (id LONG) USING delta
      TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
    w.sql("INSERT INTO tbl SELECT id + 10 FROM range(10)")
  ...
  test("cdc_metadata_filter", "CDC filtering by data values", "cdf") { w =>
    w.sql("""CREATE TABLE tbl (id LONG) USING delta
      TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true')""")
    w.sql("INSERT INTO tbl SELECT id FROM range(10)")
  ...
  test("cdc_partitioned", "CDC with partitioned table", "cdf") { w =>
  ...
  test("cdc_partitioned_dml", "CDC partitioned DML", "cdf") { w =>
    w.sql("""CREATE TABLE tbl (id LONG, category STRING, value INT) USING delta
      PARTITIONED BY (category) TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true')""")
  ...
  test("cdc_column_mapping", "CDC with column mapping", "cdf", "column_mapping") { w =>
  ...
  test("cdc_deletion_vectors", "CDC with deletion vectors", "cdf", "dv") { w =>
    w.sql("""CREATE TABLE tbl (id LONG, value INT) USING delta
      TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true', 'delta.enableDeletionVectors' = 'true')""")
  ...
  test("cdc_dv_column_mapping", "CDC + DV + column mapping", "cdf", "dv", "column_mapping") { w =>
  ...
  test("cdc_data_skipping", "CDC with data skipping", "cdf") { w =>
  ...
  test("cdc_schema_evolution", "CDC across ADD COLUMN", "cdf", "schema_evolution") { w =>
    w.sql("""CREATE TABLE tbl (id LONG, value INT) USING delta
      TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true',
  ...
  test("cdc_optimize", "CDC after OPTIMIZE", "cdf") { w =>
    w.sql("""CREATE TABLE tbl (id LONG, value INT) USING delta
      TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true')""")
  ...
  test("cdc_predicates", "CDC read with predicates", "cdf") { w =>
  ...
  test("cdc_transform", "CDC data transformation", "cdf") { w =>
  ...
  test("cdc_multiple_types", "CDC with diverse types", "cdf") { w =>
  ...
  test("cdc_nested_struct", "CDC with nested types", "cdf") { w =>
  ...
  test("cdc_map_array", "CDC with map and array", "cdf") { w =>
  ...
  test("cdc_generated_columns", "CDC with generated columns", "cdf") { w =>
  ...
  test("cdc_not_enabled", "Error: CDF on table without CDF", "cdf", "error") { w =>
  ...
  test("cdc_many_versions", "CDF with 10+ versions", "cdf") { w =>
