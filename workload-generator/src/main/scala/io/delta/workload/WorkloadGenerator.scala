...
trait WorkloadOps {
  ...
  def readSpec(
      ...
      timestamp: String = null,
      columns: Seq[String] = null,
      name: String = null): SpecRef[ReadSpec] = current.readSpec(table, predicate, version, timestamp, columns, name)

  /** Snapshot spec. */
  def snapshotSpec(
      table: TableHandle,
      version: java.lang.Long = null,
      timestamp: String = null): SpecRef[SnapshotSpec] = current.snapshotSpec(table, version, timestamp)
