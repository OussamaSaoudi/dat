...
class IcebergCompatSuite extends WorkloadTestSuite("iceberg_compat") {
  ...
  test("ice_compat_v1") {
    ...
    readSpec(t, predicate = "name = 'bob'", name = "read_by_name")
    readSpec(t, predicate = "id > 1", name = "read_id_gt_1")
    snapshotSpec(t)
  }
  ...
  test("ice_compat_v2") {
    ...
    readSpec(t, predicate = "value > 3.0")
  ...
  test("ice_partitioned") {
    ...
    val t = registerTable("tbl")
    readSpec(t, name = "read_all")
    readSpec(t, predicate = "category = 'A'", name = "read_category_A")
    readSpec(t, predicate = "category = 'B'", name = "read_category_B")
    readSpec(t, predicate = "category = 'C'", name = "read_category_C")
    snapshotSpec(t)
  }
  ...
  test("ice_complex_types") {
    ...
    val t = registerTable("tbl")
    readSpec(t, name = "read_all")
    readSpec(t, predicate = "id = 2", name = "filter_id")
    snapshotSpec(t)
  }
  ...
  test("ice_partition_evolution") {
    ...
    val t = registerTable("tbl")
    readSpec(t, name = "read_all")
    readSpec(t, predicate = "category = 'cat_a'", name = "filter_partition")
    snapshotSpec(t)
  }
